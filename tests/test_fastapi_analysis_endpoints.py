...
class FastApiAnalysisEndpointTests(unittest.TestCase):
    ...
    def test_text_analysis_nb(self, mock_preprocess, mock_predict_cached, mock_predict_score_cached):
    ...
    @patch("src.api.fastapi_analysis.preprocess")
    def test_text_analysis_vader(self, mock_preprocess, mock_prebuilt_model, mock_vader_score):
